...
public interface IStockMovementService
{
    ...
    Task<Guid> RegisterTransferAsync(int productId, int sourceStockLocationId, int destinationStockLocationId, decimal quantity, int performedByEmployeeId, string? notes = null, CancellationToken cancellationToken = default);
