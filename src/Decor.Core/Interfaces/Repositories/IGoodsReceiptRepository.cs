...
public interface ITransactionalGoodsReceiptRepository
{
    Task<int> InsertAsync(GoodsReceipt goodsReceipt, IDbConnection connection, IDbTransaction transaction, CancellationToken cancellationToken = default);
}